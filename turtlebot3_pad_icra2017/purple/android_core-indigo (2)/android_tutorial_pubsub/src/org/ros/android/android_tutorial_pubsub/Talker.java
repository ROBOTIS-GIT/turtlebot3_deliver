...
public class Talker extends AbstractNodeMain {
    ...
    public Talker() {
        this.pub_pad_order_topic_name = "/tb3p/pad_order";
        this.sub_service_status_topic_name = "/tb3p/service_status";
        this.pub_pad_status_topic_name = "/tb3p/pad_status";
    }

    public GraphName getDefaultNodeName() {
        return GraphName.of("tb3p/pad");
    }
